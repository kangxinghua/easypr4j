package org.mycommon.easypr4j.train;
...
import org.mycommon.easypr4j.core.CoreFunc;
import org.mycommon.easypr4j.util.Convert;
import org.mycommon.easypr4j.util.Util;
...
public class ANNTrain {
    ...
    public Mat features(Mat in, int sizeData) {
        // Histogram features
        float[] vhist = CoreFunc.projectedHistogram(in, CoreFunc.Direction.VERTICAL);
        float[] hhist = CoreFunc.projectedHistogram(in, CoreFunc.Direction.HORIZONTAL);
